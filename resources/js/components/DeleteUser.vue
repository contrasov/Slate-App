...
<template>
    <div class="space-y-6">
        <HeadingSmall title="Deletar conta" description="Delete sua conta e todos os recursos" />
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            <DialogTitle>Você tem que certeza que deseja excluir sua conta?</DialogTitle>
                            <DialogDescription>
                                Uma vez que sua conta for excluída, todos os seus recursos e dados também serão permanentemente deletados. 
