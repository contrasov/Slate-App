...
<template>
    ...
    >
        ...
        <div
            :class="
                cn(
                    'fixed inset-y-0 z-10 hidden bg-white border-r border-sidebar-border h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex',
                    side === 'left'
